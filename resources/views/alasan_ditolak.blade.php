@extends('layout/main_alasan_ditolak')

@section('title', 'Alasan Pemesanan Ditolak')
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Alasan Pemesanan Ditolak</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <!-- <li class="breadcrumb-item"><a href="#">Tanda Tangan Transaksi</a></li> -->
              <li class="breadcrumb-item active">Alasan Pemesanan Ditolak</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              <form action="../PostAlasanDitolak" method="post" enctype="multipart/form-data">
              @csrf
